...
`tofu-aws` (private) defines a cold AWS footprint sized to take a Splunk failover. Cribl Edge routes can be flipped to the AWS HEC endpoint via config change. Details: [tofu-splunk-aws](/observability/repos/tofu-splunk-aws).
