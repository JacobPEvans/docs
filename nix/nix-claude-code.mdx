...
- **Permissions you can read.** Auto-approved tools, deny lists, and the WebFetch allowlist as structured Nix data — the same data feeds Codex, Antigravity, and any other AI agent you wire up.
...
- [`nix-ai`](/nix/nix-ai) — AI tool ecosystem (Claude Code binary, the Antigravity CLI, MCP servers, MLX modules)
