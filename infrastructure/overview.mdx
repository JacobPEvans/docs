...
| Repo | Purpose |
| --- | --- |
| [`tofu-aws`](https://github.com/dryvist/tofu-aws) | Splunk DR footprint — cold capacity for failover |
...
<CardGroup cols={2}>
  ...
  <Card title="tofu-splunk-aws" icon="chart-line" href="/observability/repos/tofu-splunk-aws">
