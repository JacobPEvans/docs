...
| macOS re-enslaves the Thunderbolt port into `bridge0` after a reboot, starving RDMA | **In progress** | [dryvist/nix-darwin#1768](https://github.com/dryvist/nix-darwin/issues/1768) |
...
| Loopback rendezvous dial mismatch (`[::1]` vs IPv4) | **In progress** | [dryvist/nix-ai#1330](https://github.com/dryvist/nix-ai/issues/1330) |
