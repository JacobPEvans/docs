...
| --- | --- | --- |
| automation tier | Service API keys and similar login-convenience credentials | Yes |
| elevate-access tier | Human-only break-glass material | No — GUI unlock prompt blocks non-interactive reads |
