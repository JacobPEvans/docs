...
- Live API keys that rotate frequently — `git log` keeps the encrypted history forever, and "encrypted today" is only as strong as the age key. Use the runtime manager, or an engine that mints them per call.
