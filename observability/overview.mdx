...
Diagram walkthroughs for every ingest path — syslog families, AI-CLI shipping, the LLM stack, OTLP fan-out, NetFlow, HEC fan-in — live on [Pipeline flows](/observability/pipeline-flows).
...
<CardGroup cols={2}>
  <Card title="tofu-splunk-aws" icon="aws" href="/observability/repos/tofu-splunk-aws">
