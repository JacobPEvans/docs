...
Five source groups, two ingress load balancers (HAProxy for TCP syslog, nginx for UDP), one Cribl Edge/Stream spine, three sinks: Splunk (per-index HEC), Langfuse and Phoenix (OTLP traces).
