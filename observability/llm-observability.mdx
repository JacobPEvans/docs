...
`https://<app>.<subdomain>/` and nothing else. No caller — human, agent, or
...
not about resource use — the call consumed power, memory, and time. Read cost
...
<CardGroup cols={2}>
  ...
  <Card title="ansible-proxmox-ai" icon="screwdriver-wrench" href="/infrastructure/repos/ansible-proxmox-ai">
    Deploys Langfuse. The Cribl OTEL sources it feeds come from ansible-proxmox-apps.
  </Card>
