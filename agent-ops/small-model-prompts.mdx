...
description: "How to tune goal statements and prompt blocks for a ~30 GB local model — short imperatives, explicit checklists, hard STOP conditions, and verification the model cannot skip."
