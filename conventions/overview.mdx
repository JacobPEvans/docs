...
Standards that are AI-runtime only (tool routing, skill execution semantics, LiteLLM routing) stay in [`ai-assistant-instructions`](/ai-development/ai-assistant-instructions) and are loaded as agent context. Anything humans need to read lives here.
